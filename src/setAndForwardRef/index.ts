...
type Args = Readonly<{
  getForwardedRef: () => React.Ref<any> | null
  setLocalRef: (ref: React.ElementRef<any>) => unknown
}>
...
export default function setAndForwardRef({
  getForwardedRef,
  setLocalRef,
}: Args) {
  return function forwardRef(ref: React.ElementRef<any>) {
    ...
    if (typeof forwardedRef === 'function') {
      ...
      // @dxd forwardedRef.current is readonly
      // @ts-ignore
